...
LORA_MODELS=(
    ...
    "https://civitai.com/api/download/models/120037?type=Model&format=SafeTensor"
)
...
CONTROLNET_MODELS=(
    ...
    "https://huggingface.co/h94/IP-Adapter/blob/main/models/ip-adapter-full-face_sd15.safetensors"
)
